...
class YudisiumController extends Controller
{
    public function index(Request $request)
    {
        ...
        if(!$riwayat_pendidikan->id_kurikulum ) {
            return redirect()->route('mahasiswa.kelulusan.yudisium.index')->with('error', 'Kurikulum Belum diatur, Silahkan hubungi Koor. Prodi!');
        }else{
       ...
       // dd($useptData);
        ...
        return view('mahasiswa.kelulusan.yudisium.index', [
            'aktivitas' => $aktivitas,
...
// dd($kecamatan);
        ...
        try {
            $asal_sekolah = Registrasi::leftJoin('data_sekolah', 'data_sekolah.npsn', 'reg_master.rm_pddk_slta_kode')
                    ->select('reg_master.rm_pddk_sd_nama','reg_master.rm_pddk_sd_lokasi', 'reg_master.rm_pddk_sd_thn_lulus',
                            ...
                            'reg_master.rm_pddk_slta_kode', 'reg_master.rm_pddk_slta_nama', 'reg_master.rm_pddk_slta_lokasi', 'reg_master.rm_pddk_slta_jurusan', 'reg_master.rm_pddk_slta_thn_lulus',
                            'data_sekolah.nama_sekolah', 'data_sekolah.nama_kabupaten', 'data_sekolah.nama_provinsi', 'data_sekolah.akreditasi_sekolah')
        ...
        return view('mahasiswa.kelulusan.yudisium.data-induk', ['riwayat_pendidikan' => $riwayat_pendidikan, 'semester_aktif' => $semester_aktif, 'kecamatan'=> $kecamatan,
    ...
    {       
        ...
        return view('mahasiswa.kelulusan.yudisium.data-akademik', [
    ...
    public function data_akademik_store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('mahasiswa.kelulusan.yudisium.data-tugas-akhir')->with('success', 'Data Berhasil disimpan, Silahkan lanjut ke Data Tugas Akhir!');
        } 
        catch (\Exception $e) {
            DB::rollBack();
    ...
    public function data_tugas_akhir_store(Request $request)
    {
        ...
        try {
            ...
            */
            ...
            return redirect()
                ->route('mahasiswa.kelulusan.yudisium.resume.index')
    ...
    public function resume_yudisium()
    {
        ...
        return view('mahasiswa.kelulusan.yudisium.resume_yudisium', ['riwayat_pendidikan' => $riwayat_pendidikan, 'semester_aktif' => $semester_aktif, 
    ...
    public function simpan_data(Request $request)
    {
        ...
        try {
            ...
            return back()->with('error','Data Pendaftaran Yudisium Gagal disimpan!');
    ...
    public function transkrip_mahasiswa()
    {
        ...
        return view('mahasiswa.kelulusan.yudisium.transkrip-mahasiswa', ['transkrip' => $transkrip_mahasiswa, 'total_sks_transkrip'=>$total_sks_transkrip, 'bobot'=>$bobot,'ipk'=>$ipk, 'statusSync' => $statusSync, 'id_batch' => $id_batch,]);
    }
